...
alpha_ = 0.8
N = gen_N(nc)
print('Total Population = '+str(np.sum(N)))
bw = 0.2
locs = gen_locs(nc)
bw_approx = 0.2
...
vaccine_policies = [vac_policies.prop_policy, vac_policies.Sampled_greedy,  vac_policies.risk_DLA_prime, vac_policies.susc_allocate, vac_policies.risk_DLA_param]
mv = len(vaccine_policies)
vac_names = ['even', 'sampledCFA', 'DLA-2', 'PFA', 'DLA_param']
...
vparams4 = [0.85, 0.4]
vparams5 = [6, 100, 0.5]
vparams6 = [.05, 2.5, 0.2, 1.32, .515, 240]

vparam_list = [vparams0, vparams0, vparams2, vparams1, vparams6]

# list of testing policies
testing_policies = [test_policies.full_test, test_policies.pure_exploration]
mt = len(testing_policies)
test_names = ['FULL', 'random']
# tparams0 is null policy params
tparams0 = []
tparams1 = [10]
tparams2 = [6]
tparams3 = [0.6]
tparam_list = [tparams0, tparams0]
blist = [0, 1]
blist2 = [True, True]

betahat = gen_betas(nc, T, n, 2)
